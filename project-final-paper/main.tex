...
\begin{figure}[h]
    ...
    {\includegraphics[width=0.11\textwidth]{project-final-paper/images/nerf_hairstep/output_test_6.png}} \\
     ...
     \subcaptionbox{GT}{\includegraphics[width=0.11\textwidth]{project-final-paper/images/groundtruth_orientation/output_test_7.png}}
     \subcaptionbox{Ours}{\includegraphics[width=0.11\textwidth]{project-final-paper/images/neof/output_test_7.png}}
     \subcaptionbox{HairStep}{\includegraphics[width=0.11\textwidth]{project-final-paper/images/groundtruth_hairstep/output_test_7.png}}
     \subcaptionbox{NeRF}{\includegraphics[width=0.11\textwidth]{project-final-paper/images/nerf_hairstep/output_test_7.png}}
